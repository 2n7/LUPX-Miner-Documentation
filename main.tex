...
A default gas price and gas limit is set in the code but can easily be changed to onces preferences. A few preconfigured settings come with the miner:
\begin{itemize}
\item cheap: low gas usage but slower transactions
